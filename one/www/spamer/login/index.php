...
<head>
	...
	<script type="text/javascript" src="/admin/engine/js/login.js?1v41234sa112f2"></script>
...
<body class="text-center">
    <form class="form-signin" method="POST" id="splogin" action="/admin/engine/account/spamerlogin.php" autocomplete="off">
